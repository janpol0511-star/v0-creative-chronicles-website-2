        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="relative animate-fade-in-right animation-delay-300">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-border shadow-2xl transition-transform duration-500 hover:scale-[1.02] bg-black h-64 sm:h-80 lg:h-[520px] w-full lg:w-[110%] xl:w-[120%] lg:translate-x-6">
                <video
